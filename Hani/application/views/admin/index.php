...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>assets/images/haloalumni.png">
    <title>Halo Alumni</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<?php if ($this->session->userdata('role') == 'admin'): ?>
                        <li>
								<a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">User Web</span></a>
						...
						<!-- Profile -->
                        <!-- <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/profile') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Profile</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/user/myprofile') ?>"><i class="fa fa-angle-right"></i> My Profile</a></li>
								<li><a href="<?php echo base_url('admin/user/changepassword') ?>"><i class="fa fa-angle-right"></i> Change Password</a></li>
                            </ul>
                        </li> -->
                        ...
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/sambutan') ?>" aria-expanded="false"><i class="mdi mdi-handshake"></i><span class="hide-menu">Sambutan</span></a>
                        </li>						

						<hr>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/hani/entrylevel') ?>" aria-expanded="false"><i class="mdi mdi-laptop"></i><span class="hide-menu">Info Loker</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/hani/entrylevel') ?>"><i class="fa fa-angle-right"></i> Web</a></li>
								<li><a href="<?php echo base_url('admin/infoloker/') ?>"><i class="fa fa-angle-right"></i> Alumni</a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/midlevel') ?>" aria-expanded="false"><i class="mdi mdi-newspaper-variant-multiple-outline"></i><span class="hide-menu">Career News</span></a>
                        </li>

                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/campushiring') ?>" aria-expanded="false"><i class="mdi mdi-newspaper-variant-outline"></i><span class="hide-menu">Campus Hiring</span></a>
                        </li>

                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/unikanews') ?>" aria-expanded="false"><i class="mdi mdi-newspaper"></i><span class="hide-menu">Unika News</span></a>
                        </li>

                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/ikasopera') ?>" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Ikasoepra</span></a>
						</li>
						
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/metamorfosa') ?>" aria-expanded="false"><i class="mdi mdi-clipboard-multiple-outline"></i><span class="hide-menu">Metamorfosa</span></a>
						</li>
						
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hani/video') ?>" aria-expanded="false"><i class="mdi mdi-library-movie"></i><span class="hide-menu">Video</span></a>
						</li>
						...
						<?php if ($this->session->userdata('role') == 'admin'): ?>
							<li>
								<a class="waves-effect waves-dark" href="<?php echo base_url('admin/infoloker/list') ?>" aria-expanded="false"><i class="mdi mdi-monitor-edit"></i><span class="hide-menu">Acc Loker</span></a>
							</li>
						<?php else: ?>
						<?php if(check_power(1)):?>
							<li>
						...
						<?php endif ?>
						<li>
							<a class="waves-effect waves-dark" href="<?php echo base_url('admin/infoloker/add') ?>" aria-expanded="false"><i class="mdi mdi-monitor-edit"></i><span class="hide-menu">Pasang Loker</span></a>
						</li>
						<?php endif ?>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/ideafunding') ?>" aria-expanded="false"><i class="mdi mdi-lightbulb-on-outline"></i><span class="hide-menu">Idea Funding</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/ideafunding/add') ?>"><i class="fa fa-angle-right"></i> Add Idea</a></li>
								<li><a href="<?php echo base_url('admin/ideafunding/') ?>"><i class="fa fa-angle-right"></i> Idea List</a></li>
                            </ul>
                        </li>
						...
						<?php if ($this->session->userdata('role') == 'admin'): ?>
							<li>
								<a class="waves-effect waves-dark" href="<?php echo base_url('admin/kontak/list') ?>" aria-expanded="false" ><i class="mdi mdi-contact-mail"></i><span class="hide-menu">Pesan Masuk</span></a>
							</li>
						<?php else: ?>
						<?php if(check_power(1)):?>
							<li>
						...
						<?php endif ?>
						<li>
							<a class="waves-effect waves-dark" href="<?php echo base_url('admin/kontak/') ?>" aria-expanded="false"><i class="mdi mdi-contact-mail"></i><span class="hide-menu">Kontak</span></a>
						</li>
						<?php endif ?>
        ...
        <!-- ==========================Dynamicaly Show Main Page Content============================ -->
            ...
            <footer class="footer">
                © 2020 Halo Alumni Unika Soegijapranata
            </footer>
	...
	<script>
		...
		// Morris bar chart
			Morris.Bar({
				...
				data: serries,
				xkey: 'month',
				ykeys: ['idea_funding', 'info_loker',],
				labels: ['Idea Funding', 'Info Loker',],
