...
<div class="container-fluid">
            ...
            <div class="d-flex m-t-10 justify-content-end">
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                    <div class="chart-text m-r-10">
                        <h6 class="m-b-0"><small>Total Idea Funding</small></h6>
                        <h4 class="m-t-0 text-primary"><?php echo $count->total_idea_funding; ?></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <!-- Row -->
            <div class="row">
			<?php foreach ($idea_funding as $idea): ?>
					<!-- column -->
					<div class="col-lg-3 col-md-6 img-responsive">
						<!-- Card -->
						<div class="card card-outline-primary">
							<div class="card-header">
                    			<p class="m-b-0 text-white"><?php echo my_date_show_time($idea['create_date']); ?></p></div>
								<img class="card-img-top img-responsive" src="<?php echo base_url() ?>assets/images/idea/<?php echo $idea['image']; ?>" alt="Card image cap">
							<div class="card-body">
								<h4 class="card-title"><?php echo $idea['title']; ?></h4>
								<p class="card-text"><small class="text-muted"><?php echo $idea['text']; ?></small></p>
								<br>
								<p class="card-text"><small class="text-muted">Author - <?php echo $idea['create_by']; ?></small></p>
