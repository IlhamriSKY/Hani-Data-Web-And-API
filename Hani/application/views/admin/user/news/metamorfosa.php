...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Metamorfosa</h3>
        </div>
					...
					<div class="col-lg-3 col-md-6 img-responsive">
						...
						<div class="card card-outline-primary">
							<div class="card-header">
								...
								<img class="card-img-top img-responsive" src="<?php echo base_url() ?>assets/images/lowongan/metamorfosa/<?php echo $characters->images[$urls]; ?>" alt="Card image cap">
							<div class="card-body">
