...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Ikasopera</h3>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
				<?php
					$url = 'https://haniapi.mooo.com/ikasopera'; // path to your JSON file
					...
					<div class="col-lg-3 col-md-6 img-responsive">
						...
						<div class="card card-outline-primary">
							<div class="card-header">
								...
								<img class="card-img-top img-responsive" src="<?php echo $characters->images[$urls][0]; ?>" alt="Card image cap">
							<div class="card-body">
