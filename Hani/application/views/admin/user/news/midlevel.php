...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Mid Level</h3>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
				<?php
					$url = 'https://haniapi.mooo.com/midlevel'; // path to your JSON file
				...
				<?php foreach ($characters->url as $urls => $index): ?>
					...
					<div class="col-lg-3 col-md-6 img-responsive">
						<!-- Card -->
						<div class="card">
							<img class="card-img-top img-responsive" src="<?php echo base_url() ?>assets/images/lowongan/midlevel/<?php echo $characters->images[$urls]; ?>" alt="Card image cap">
							<div class="card-body">
