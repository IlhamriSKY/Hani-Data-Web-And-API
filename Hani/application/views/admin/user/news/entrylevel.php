...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Entry Level</h3>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
				<?php
					$url = 'https://haniapi.mooo.com/entrylevel'; // path to your JSON file
				...
				<?php foreach ($characters->url as $urls => $index): ?>
					...
					<div class="col-lg-3 col-md-6 img-responsive">
						<!-- Card -->
						<div class="card">
							<img class="card-img-top img-responsive" src="<?php echo base_url() ?>assets/images/lowongan/entrylevel/<?php echo $characters->images[$urls]; ?>" alt="Entry Level">
							<div class="card-body">
								<h4 class="card-title"><?php echo $characters->judul[$urls]; ?></h4>
								<p class="card-text"><small class="text-muted"><?php echo $characters->date[$urls]; ?></small></p>
